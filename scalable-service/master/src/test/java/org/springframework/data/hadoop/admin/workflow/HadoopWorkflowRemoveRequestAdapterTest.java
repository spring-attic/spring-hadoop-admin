 ...
 *
 */
public class HadoopWorkflowRemoveRequestAdapterTest {

	private HadoopWorkflowRemoveRequestAdapter removeRequest;
	...
	public void setUp() throws Exception {
		removeRequest = new HadoopWorkflowRemoveRequestAdapter();
	...
	/**
	 * Test method for {@link org.springframework.data.hadoop.admin.workflow.HadoopWorkflowRemoveRequestAdapter#handleRemoveFile(java.io.File)}.
	 */
	@Test
	public void testHandleRemoveFile() {
		...
		removeRequest.setApplicationContext(context);
		removeRequest.handleRemoveFile(descriptor);

		jobNames = jobRegistry.getJobNames();
